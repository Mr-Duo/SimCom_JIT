...
def load_data(args):
    train_path_data = (f'/home/aiotlab3/RISE/Manh/data/{args.project}/cross/k_test.csv')
    test_path_data = (f'/home/aiotlab3/RISE/Manh/data/{args.project}/cross/k_test.csv')
